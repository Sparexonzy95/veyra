...
def _open_pull_request(
    ...
    *,
    ...
    body = (
        ...
        "validated the committed policy, and published the result through the "
    ...
    payload = github._request(  # shared authenticated client; token never logged
        ...
        json_payload={
            ...
            "head": f"{item.worker.github_username}:{branch_name}",
...
def execute_worker_job(
    ...
    *,
    ...
    try:
        ...
        email = (
            f"{authenticated['id']}+{item.worker.github_username}"
