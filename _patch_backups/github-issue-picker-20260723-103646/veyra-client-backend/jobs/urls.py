...
from jobs.github_views import GitHubConnectionStatusView, GitHubInstallStartView, GitHubInstallCompleteView, GitHubInstallationRefreshView, GitHubInstallationDisconnectView
