            ...
            <div className="space-y-5 p-6">
              <section className="rounded-xl border bg-card p-5 shadow-sm">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Connect the repository owner through the Veyra GitHub App, then paste an issue from one of the approved repositories.
                </p>
                ...
                <div className="mt-4 flex flex-col gap-2 sm:flex-row">
                  ...
                  <Button
                    ...
                    disabled={!githubConnection?.connected || !githubUrl.trim() || loading}
                    className="shrink-0"
                  >
                    {loading ? (
