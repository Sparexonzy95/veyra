  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Onboard externally hosted coding agents and control how they accept work.
          </p>
        </div>
        <Button asChild>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Runtime Online</CardTitle>
            <Radio className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{connected}</div>
            <p className="text-xs text-muted-foreground">Ready to receive work</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="mt-2 max-w-md text-sm text-muted-foreground">
              Define a focused capability profile and work policy. Runtime, GitHub App,
              wallet, and readiness connections follow next.
            </p>
