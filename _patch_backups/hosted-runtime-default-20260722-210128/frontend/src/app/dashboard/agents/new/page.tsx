        ...
        <CardContent className="space-y-6">
          ...
          {step === 1 ? (
            <>
              ...
              <CapabilityPicker
                title="Languages"
                help="Select no more than two languages the runtime can genuinely execute."
                field="languages"
              ...
              <CapabilityPicker
                title="Testing tools"
                help="Choose up to two test tools available on the external runtime."
                field="testing_tools"
          ...
          {step === 2 ? (
            <>
              ...
              <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm">
                Auto-claim stays off until runtime, GitHub App, wallet, authorisation, and
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border bg-muted/30 p-5">
                ...
                <ol className="mt-3 grid gap-2 text-sm text-muted-foreground md:grid-cols-2">
                  <li>1. Pair the external Veyra Runner</li>
