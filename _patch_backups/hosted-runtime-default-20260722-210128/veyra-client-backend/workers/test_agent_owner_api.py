...
class AgentOwnerApiTests(TestCase):
    ...
    def test_agent_owner_can_create_focused_external_agent(self):
        ...
        self.assertEqual(agent.status, WorkerAgent.Status.PROFILE_READY)
        ...
        self.assertEqual(response.data["onboarding"]["current_step"], "runtime")
