    ...
    def create_authorisation(
        ...
        *,
        ...
        payload = {
            ...
            "abiFunctionSignature": "setAgentAuthorised(address,bool)",
            "abiParameters": [agent_address, "true"],
            "feeLevel": getattr(
                settings,
        ...
        try:
            ...
            raise ContractAuthorisationError(
                f"Circle agent-authorisation transaction failed: {_safe_message(exc)}"
            ) from exc
...
def authorise_worker_contract(
    ...
    *,
    ...
    owner_address = _contract_owner_address(arc)
