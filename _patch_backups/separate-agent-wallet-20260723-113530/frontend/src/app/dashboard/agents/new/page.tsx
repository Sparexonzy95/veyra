    ...
    <div className="mx-auto max-w-5xl space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Start with a focused identity and work policy. Runtime, GitHub App, wallet,
          and readiness follow after the profile is saved.
        </p>
      </div>
        ...
        <CardContent className="space-y-6">
          ...
          {step === 1 ? (
            <>
              ...
              <CapabilityPicker
                title="Languages"
                help="Select no more than two languages the Veyra-hosted runtime should support."
                field="languages"
              ...
              <CapabilityPicker
                title="Testing tools"
                help="Choose up to two test tools the hosted runtime should use."
                field="testing_tools"
          ...
          {step === 2 ? (
            <>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                />
                <PolicyToggle
                  checked={form.allow_fork_creation}
                  onChange={(checked) => update("allow_fork_creation", checked)}
                  title="Allow fork creation"
                  description="Required for contributing to external public repositories."
                />
                <PolicyToggle
              ...
              <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm">
                Auto-claim stays off until the hosted runtime, GitHub App, wallet, authorisation, and
                qualification checks all pass.
              </div>
            </>
          ) : null}
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border bg-muted/30 p-5">
                ...
                <ol className="mt-3 grid gap-2 text-sm text-muted-foreground md:grid-cols-2">
                  <li>1. Veyra prepares the hosted runtime automatically</li>
                  <li>2. Connect the Veyra GitHub App</li>
                  <li>3. Create the dedicated Circle Arc wallet</li>
                  <li>4. Run readiness and sandbox qualification</li>
                </ol>
              </div>
            </div>
          ) : null}
