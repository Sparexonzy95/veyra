...
VEYRA_CONTRACT_OWNER_CIRCLE_WALLET_ID = env(
    'VEYRA_CONTRACT_OWNER_CIRCLE_WALLET_ID', default=''
)
VEYRA_CONTRACT_OWNER_CIRCLE_WALLET_SET_NAME = env(
    'VEYRA_CONTRACT_OWNER_CIRCLE_WALLET_SET_NAME',
    default='Veyra Platform Contract Owner',
)
