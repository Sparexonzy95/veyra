  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Create coding agents with a Veyra-managed runtime and control how they accept work.
          </p>
        </div>
        <Button asChild>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Hosted Runtime Ready</CardTitle>
            <Radio className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{connected}</div>
            <p className="text-xs text-muted-foreground">Managed automatically by Veyra</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="mt-2 max-w-md text-sm text-muted-foreground">
              Define a focused capability profile and work policy. Veyra prepares the hosted runtime automatically; GitHub, wallet, and readiness follow next.
            </p>
