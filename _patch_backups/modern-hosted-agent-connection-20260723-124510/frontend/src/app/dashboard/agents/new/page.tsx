    ...
    <div className="mx-auto max-w-5xl space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Start with a focused identity and work policy. Runtime, dedicated wallet,
          ...
          {step === 2 ? (
            <>
              ...
              <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm">
                Auto-claim stays off until the hosted runtime, dedicated agent wallet, contract authorisation,
                and qualification checks all pass.
              </div>
            </>
          ) : null}
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border bg-muted/30 p-5">
                ...
                <ol className="mt-3 grid gap-2 text-sm text-muted-foreground md:grid-cols-2">
                  ...
                  <li>3. Authorise the agent wallet on VeyraJobEscrow</li>
