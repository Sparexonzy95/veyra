    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name="workers_run_owner_u_1f2ed2_idx",
            ),
            models.Index(
                fields=["last_seen_at"],
                name="workers_run_last_se_72f412_idx",
            ),
        ]
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name="workers_run_runner__584890_idx",
            ),
            models.Index(
                fields=["worker", "status"],
                name="workers_run_worker__7e6036_idx",
            ),
        ]
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name="workers_run_worker__b8222f_idx",
            ),
            models.Index(
                fields=["owner_user", "expires_at"],
                name="workers_run_owner_u_071f0e_idx",
            ),
        ]
