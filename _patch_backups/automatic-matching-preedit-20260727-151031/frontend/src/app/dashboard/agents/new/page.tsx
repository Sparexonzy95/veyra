  ...
  function validateCurrentStep() {
    ...
    if (step === 3) {
      if (!form.connection_link.trim().startsWith("veyra-connect://")) {
        toast.error("Paste the connection link generated by the hosted-agent server.");
        return false;
      }
    }
    return true;
    ...
    <div className="mx-auto max-w-5xl space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Add the owner-hosted agent details and paste one connection link. Veyra handles
            ...
            <div className="space-y-6">
              <div className="rounded-xl border bg-muted/30 p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">Connect the owner-hosted brain</p>
                    <p className="mt-1 text-sm text-muted-foreground">
                      Open the agent server dashboard, copy its Veyra connection link, and paste it below.
                      The paid AI key remains on that server.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="connection-link">Veyra connection link</Label>
                <Textarea
                  id="connection-link"
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border bg-muted/30 p-5">
                ...
                <ol className="mt-3 grid gap-2 text-sm text-muted-foreground md:grid-cols-2">
                  <li>1. Verify and claim the owner-hosted runtime</li>
      ...
      <div className="flex items-center justify-between">
        ...
        {step < steps.length - 1 ? (
          ...
          <Button type="button" onClick={() => void createAgent()} disabled={saving}>
            ...
            {saving ? "Connecting and provisioning..." : "Create and Connect Agent"}
          </Button>
        )}
      </div>
    </div>
