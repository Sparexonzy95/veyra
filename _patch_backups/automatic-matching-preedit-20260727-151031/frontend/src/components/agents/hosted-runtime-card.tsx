          ...
          <div className="space-y-4 rounded-xl border p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  {agent.provisioning_error ||
                    ...
                    (ready
                      ? "The hosted brain is online. Retry will reuse this runtime and continue the remaining setup."
            ...
            {needsFreshLink ? (
              ...
              <div className="flex items-start gap-2 rounded-lg bg-muted/40 p-3 text-sm text-muted-foreground">
                ...
                Runtime ownership is already verified. Retrying will reuse the same agent, runtime, and wallet.
              </div>
            )}
