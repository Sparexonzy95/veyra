...
$root = "C:\Users\cashkink\Downloads\Veyra-backend\veyra-agent-test-server"
...
Get-ChildItem "C:\Users\cashkink\Downloads\Veyra-backend" -Recurse -Force -File -Filter "state.json" -ErrorAction SilentlyContinue | ForEach-Object {
    try {
