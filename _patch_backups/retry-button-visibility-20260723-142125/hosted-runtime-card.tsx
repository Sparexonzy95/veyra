      ...
      <CardHeader className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          <CardTitle className="flex items-center gap-2">
            <ServerCog className="h-5 w-5" /> Owner-Hosted Brain
          </CardTitle>
          <Badge
            variant={
              ready
        ...
        <p className="text-sm text-muted-foreground">
          The owner hosts the coding runtime and pays for its AI model. Veyra receives
        ...
        {ready ? (
          <div className="flex items-start gap-3 rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                ...
                The runtime will receive jobs through its Veyra credential, not through the owner&apos;s AI key.
              </p>
          ...
          <div className="space-y-4 rounded-xl border p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">Connection or provisioning needs attention</p>
                <p className="mt-1 text-sm text-muted-foreground">
                  {agent.provisioning_error || runtime.health_message || "Paste a fresh connection link and retry."}
                </p>
              </div>
            </div>
            ...
            {needsFreshLink ? (
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm font-medium">
                  <Link2 className="h-4 w-4" /> Fresh Veyra connection link
                </div>
                <Input
              ...
              <div className="flex items-start gap-2 rounded-lg bg-muted/40 p-3 text-sm text-muted-foreground">
                ...
                Runtime ownership is already verified. Retrying will reuse the same agent and wallet.
              </div>
            )}
            ...
            >
              ...
              {busy ? "Retrying automatic setup…" : "Retry automatic setup"}
            </Button>
          </div>
        )}
      </CardContent>
