...
ARC_RPC_URLS = env('ARC_RPC_URLS', default='')
ARC_RPC_TIMEOUT_SECONDS = env.int('ARC_RPC_TIMEOUT_SECONDS', default=20)
ARC_RPC_COOLDOWN_SECONDS = env.int('ARC_RPC_COOLDOWN_SECONDS', default=30)
...
VEYRA_JOB_MAX_RUNTIME_ATTEMPTS = env.int(
...
VEYRA_QUALIFICATION_MAX_AGE_DAYS = env.int(
    'VEYRA_QUALIFICATION_MAX_AGE_DAYS', default=30
)
